...
def get_centers(graph_name:str,embedding_model:str,entity_list1:list[str]):
    ...
    as the cluster radius and the closest entity to that point.'''
    ...
    for center_type in centers:
        ...
        centers[center_type]["radio"]=float(centers[center_type]["radio"])
...
def get_overlap(graph_name:str,embedding_model:str,entity_list1:list[str],entity_list2:list[str],center_type:str):
    ...
    r_1=centers_1[center_type]["radio"]
    r_2=centers_2[center_type]["radio"]
