...
def predict_link(graph_name:str,embedding_model:str,head:str,tail:str,k:int) -> list[Prediction]:
...
def predict_entity(graph_name:str,embedding_model:str,head:str,relationship:str,k:int) -> list[Prediction]:
